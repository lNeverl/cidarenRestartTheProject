# 重要通知，8点前  22点后可以使用      为保证公平竞争，2020外教社-词达人杯期间（5.6日到5.20日），题库api停止服务，本软件届时无法使用，可能持续全天，望众知。实在没办法你们就用有道词典截屏翻译呗，到时候应该全网都不会提供服务。
。
。
。
。
...
## 现在还在深度测试中目前有bug可以反馈 理论支持竞赛  测试  学习 自学  
...
class Handlers
{
    ...
    */
    ...
    static function OnBeforeResponse(oSession: Session) {
        if(oSession.uriContains("https://gateway.vocabgo.com/Student")){
...
4.此时打开词达人开始做题，可以看到fiddler开始抓包了，最新的抓到的词达人的数据，在最下边。一定要找到词达人的包，词达人的包具有如下特点：(1)第一列图标为绿色箭头指向右边。第四列`host`为`gateway.vocabgo.com`。
